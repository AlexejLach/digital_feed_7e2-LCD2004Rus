...
void Feed_Ext_Front()
{
   ...
   {  
      ...
      else if (cycle_flag == false && Pass_Nr > Pass_Total)
      {
        ...
        if (Sub_Mode_Feed == Sub_Mode_Feed_Ext && limit_Front_flag == ON && limit_Rear_flag == ON){ Limit_Pos_Left = Limit_Pos_Right + Otskok_Z;} else {Limit_Pos_Left = Limit_Pos_Right + REBOUND_Z;}
   ...
   else if (Motor_X_Pos == Limit_Pos_Front && Motor_Z_Pos == Limit_Pos_Left && Step_X_flag == OFF)
   {
      ...
      if (Sub_Mode_Feed == Sub_Mode_Feed_Ext && limit_Front_flag == ON && limit_Rear_flag == ON){Limit_Pos_Right = (Limit_Pos_Left - Otskok_Z);} else {Limit_Pos_Right = (Limit_Pos_Left - REBOUND_Z);}
