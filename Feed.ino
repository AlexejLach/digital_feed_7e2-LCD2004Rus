...
//         if (flag_hand_No == ON && Scale == HC_SCALE_10){
//         if (Infeed_Value == 0)
//         {
//            if (Pass_Nr == 1) Limit_Pos_Left = (Null_Z_Pos + 1);
//            else              Limit_Pos_Left = (Limit_Pos_Right + 1);
//         }
//         else
//         {
//            if (Pass_Nr == 1) Limit_Pos_Left = (Null_Z_Pos + Infeed_Value);
//            else              Limit_Pos_Left = (Limit_Pos_Right + 1 + Infeed_Value);
//         }}
//         else {
        if (Infeed_Value == 0)
         {
      ...
      else if (cycle_flag == false && Pass_Nr > Pass_Total)
      {
        ...
        // if (flag_hand_No == ON && Scale == HC_SCALE_10){ Limit_Pos_Left = Limit_Pos_Right + 1;} else {Limit_Pos_Left = Limit_Pos_Right + REBOUND_Z;}
   ...
   else if (Motor_X_Pos == Limit_Pos_Front && Motor_Z_Pos == Limit_Pos_Left && Step_X_flag == OFF)
   {
      ...
      //if (flag_hand_No == ON && Scale == HC_SCALE_10){Limit_Pos_Right = (Limit_Pos_Left - 1);} else {Limit_Pos_Right = (Limit_Pos_Left - REBOUND_Z);}
