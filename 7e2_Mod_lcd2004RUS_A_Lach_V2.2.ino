...
#define MOTOR_Z_STEP_PER_REV 240      // Кол-во шагов двигателя на оборот винта Z, продольная
#define SCREW_Z              200      // Шаг продольного винта Z в сотках, 2мм    
#define McSTEP_Z             5        // Микрошаг, ось Z, продольная
#define MOTOR_X_STEP_PER_REV 500      // Кол-во шагов двигателя на оборот винта X, поперечная
