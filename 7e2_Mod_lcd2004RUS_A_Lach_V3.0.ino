...
#define MAX_RAPID_MOTION     60                      // Меньше - бОльшая конечная скорость           //6000000/32/((85+1)*2)/400*60=163rpm
#define MIN_RAPID_MOTION    (MAX_RAPID_MOTION + 180) // Больше - мЕньшая начальная скорость, max 255 //6000000/32/((165+85+1)*2)/400*60=56rpm
...
//{ 1, 5000, 0, 9000, "4.00mm", 4, 34, 80  }, //  ось X ошибка
//{ 1, 3333, 0, 8000, "4.50mm", 4.5, 38, 80  }, //  ось X ошибка
//{ 1, 2000, 0, 7200, "5.00mm", 5, 42, 80  }, //  ось X ошибка
//{ 1, 909, 0, 6545, "5.50mm", 5.5, 46, 80  }, //  ось X ошибка
//{ 1, 0, 0, 6000, "6.00mm", 6, 50, 80  }, //  ось X ошибка
// Резьба дюймовая
//{  1, 4173, 0, 8504, " 6tpi ", 4.233, 36, 80  }, //  ось X ошибка
//{  1, 6535, 0, 9921, " 7tpi ", 3.629, 31, 80  }, //  ось X ошибка
{ 1, 8898, 1, 1339, " 8tpi ", 3.175, 27, 80  },
{ 2, 1260, 1, 2756, " 9tpi ", 2.822, 25, 80  },
{ 2, 3622, 1, 4173, "10tpi ", 2.54, 22, 80  },
{ 2, 5984, 1, 5591, "11tpi ", 2.309, 20, 80  },
{ 2, 8346, 1, 7008, "12tpi ", 2.117, 19, 80  },
{ 3,  709, 1, 8425, "13tpi ", 1.954, 18, 80  },
{ 3, 3071, 1, 9843, "14tpi ", 1.814, 17, 80  },
...
{ 6, 6142, 3, 9685, "G 1/16", 0.907, 9, 440 },
{ 6, 6142, 3, 9685, "G  1/8", 0.907, 9, 440  },
{ 4, 4882, 2, 6929, "G  1/4", 1.337, 13, 380  },
{ 4, 4882, 2, 6929, "G  3/8", 1.337, 13, 380 },
{ 3, 3071, 1, 9843, "G  1/2", 1.814, 17, 80 },
{ 3, 3071, 1, 9843, "G  3/4", 1.814, 17, 80 },
{ 2, 5984, 1, 5591, "G 1   ", 2.309, 20, 80 },
{ 2, 5984, 1, 5591, "G1 1/4", 2.309, 20, 80 },
{ 2, 5984, 1, 5591, "G1 1/2", 2.309, 20, 80 },
{ 2, 5984, 1, 5591, "G 2   ", 2.309, 20, 80 },
// Трубная резьба 60 градусов (K)
{ 6, 3780, 3, 8268, "K 1/16", 0.941, 10, 420 },
{ 6, 3780, 3, 8268, "K  1/8", 0.941, 10, 420 },
{ 4, 2520, 2, 5512, "K  1/4", 1.411, 13, 380 },
{ 4, 2520, 2, 5512, "K  3/8", 1.411, 13, 380 },
{ 3, 3071, 1, 9843, "K  1/2", 1.814, 17, 80 },
{ 3, 3071, 1, 9843, "K  3/4", 1.814, 17, 80 },
{ 2, 7165, 1, 6299, "K 1   ", 2.209, 20, 80 },
{ 2, 7165, 1, 6299, "K1 1/4", 2.209, 20, 80 },
{ 2, 7165, 1, 6299, "K1 1/2", 2.209, 20, 80 },
{ 2, 7165, 1, 6299, "K 2   ", 2.209, 20, 80 },
// Резьба модульная
{ 19, 1083, 11, 4650, "0,1 m", 0.314, 5, 720 },
{ 15, 9151, 9, 5491, "0,12 m", 0.377, 5, 660 },
{ 15, 2672, 9, 1603, "0,125m", 0.393, 5, 640 },
{ 12, 7389, 7, 6433, "0,15 m", 0.471, 6, 580 },
{ 11, 9284, 7, 1571, "0,16 m", 0.503, 6, 560 },
{ 9, 5541, 5, 7325, "0,2  m", 0.628, 7, 500 },
{ 7, 6433, 4, 5860, "0,25 m", 0.785, 8, 460 },
{ 6, 3694, 3, 8217, "0,3  m", 0.942, 10, 420 },
{ 6, 606, 3, 6364, "0,315m", 0.99, 10, 420 },
{ 5, 4545, 3, 2727, "0,35 m", 1.1, 11, 400 },
{ 4, 7733, 2, 8640, "0,4  m", 1.257, 12, 400 },
{ 3, 8192, 2, 2915, "0,5  m", 1.571, 15, 360 },
{ 3, 1830, 1, 9098, "0,6  m", 1.885, 17, 80 },
{ 3, 318, 1, 8191, "0,63 m", 1.979, 18, 80 },
{ 2, 7285, 1, 6371, "0,7  m", 2.199, 20, 80 },
{ 2, 3876, 1, 4326, "0,8  m", 2.513, 22, 80 },
{ 2, 1224, 1, 2734, "0,9  m", 2.827, 25, 80  },
{ 1, 9096, 1, 1458, "1    m", 3.142, 27, 80  },
{ 1, 6978, 1, 187, "1,125m", 3.534, 30, 80 },
//{ 1, 5279, 0, 9167, "1,25 m", 3.927, 33, 80 }, //  ось X ошибка
//{ 1, 3889, 0, 8333, "1,375m", 4.32, 37, 80 }, //  ось X ошибка
